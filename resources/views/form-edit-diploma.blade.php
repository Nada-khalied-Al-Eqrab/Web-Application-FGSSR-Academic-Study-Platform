            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body" style="direction: rtl; justify-content: right; text-align: right;">
                        ...
                        <form class="form-horizontal m-t-30" action="{{ route('diplomas.update', $diploma->id) }}"
                            method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <div class="form-group text-center">
                                    <img id="preview" src="{{ asset($diploma->img_url) }}" alt="Profile Picture"
