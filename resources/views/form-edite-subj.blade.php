            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body" style="direction: rtl; justify-content: right; text-align: right;">
                        ...
                        <form class="form-horizontal m-t-30" action="{{ route('courses.update', $course->id) }}"
                            method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <div class="form-group text-center">
                                    <img id="preview" src="{{ asset($course->img_url) }}" alt="Profile Picture"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" value="{{ $course->code }}"
                                                name="code">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select class="form-control" name="language" required
                                                ...
                                                <option value="AR" @selected($course->language == 'AR')>اللغة العربية</option>
                                                <option value="EN" @selected($course->language == 'EN')>اللغة الانجليزية
                                                </option>
                                            </select>
                                            <span class="input-group-text"><i class="fa fa-book"></i></span>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" value="  {{ $course->name_ar }}"
                                                name="name_ar">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <label class="form-label">اسم المادة باللغة الانجليزية <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" value=" {{ $course->name_en }}"
                                                    name="name_en">
                                                <span class="input-group-text"><i class="fa fa-language"></i></span>
                                            </div>
                                        </div>
