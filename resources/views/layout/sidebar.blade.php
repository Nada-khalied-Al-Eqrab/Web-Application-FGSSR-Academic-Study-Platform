        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link  waves-effect waves-dark"
                        href="{{route('dashboard')}}" aria-expanded="false"><i class="ti-home"></i><span
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item"><a href="{{ route('courses_registration') }}" class="sidebar-link"><i
                                    class="mdi mdi-lightbulb-on-outline"></i><span class="hide-menu">كيفية تسجيل
                                    المواد</span></a></li>
                        <li class="sidebar-item"><a href="{{ route('StudentGuide') }}" class="sidebar-link"><i
                                    class="mdi mdi-cards-variant"></i> <span class="hide-menu"> دليل
                                    الطالب</span></a></li>
                        <li class="sidebar-item"><a href="{{ route('StudyPlan') }}" class="sidebar-link"><i
                                    class="mdi mdi-clock-end"></i><span class="hide-menu"> خطة الدراسة
                                </span></a></li>
                        <li class="sidebar-item"><a href="{{ route('Graduation') }}" class="sidebar-link"><i
                ...
                <li class="sidebar-item mega-dropdown"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        @foreach ($sidebar_diplomas as $diploma)
                            <li class="sidebar-item">
                                <a href="{{ route('course_diploma.show', $diploma->id) }}" class="sidebar-link">
                                    <i class="mdi mdi-library"></i>
                                    <span class="hide-menu"> {{ $diploma->name_ar }}</span>
                                </a>
                            </li>
                        @endforeach
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="#"
                            ...
                            <ul aria-expanded="false" class="collapse second-level">
                                <li class="sidebar-item"><a href="https://www.facebook.com/FGSSR.CU" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu">

                                             الصفحة الرسمية </span></a></li>
                                <li class="sidebar-item"><a href="https://www.facebook.com/fgssr.prm" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu"> ادارة
                                            العلاقات
                                            العامة و التسويق</span></a></li>
                                <li class="sidebar-item"><a href="https://www.facebook.com/MYKNA.FGSSR" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu"> الدراسات
                                            الاكـاديمية
                                            و الـخاصة </span></a></li>
                                <li class="sidebar-item"><a href="https://www.facebook.com/TrainingFGSSR" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu"> ادارة
                                            التدريب
                                            و اختبارات القبول</span></a></li>
                                <li class="sidebar-item"><a href="https://www.facebook.com/profile.php?id=100084933785235" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu">
                                            قسم الاحصاء الحيوى و السكانى
                                              </span></a></li>
                                <li class="sidebar-item"><a href="https://www.facebook.com/fgssr.io3" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu">
                                               المكتب الاعلامى
                                              </span></a></li>
                                <li class="sidebar-item"><a href="https://www.facebook.com/ProfessionalProgramsFGSSR" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu">
                                               البرامج المهنية
                                              </span></a></li>
                                <li class="sidebar-item"><a href="https://www.facebook.com/DatascienceProgramFGSSR" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu">
                                               برامج علوم البيانات
                                              </span></a></li>
                                <li class="sidebar-item"><a href="https://www.facebook.com/profile.php?id=61568438462103" class="sidebar-link"> <i
                                            class="mdi mdi-facebook-box"></i> <span class="hide-menu">
                                               وحدة ضمان الجودة
                                              </span></a></li>
                            </ul>
                ...
                <li class="sidebar-item "> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        {{-- <li class="sidebar-item"><a href="authentication-register.html" class="sidebar-link"><i
                                    ...
                                    حساب</span></a></li> --}}
                        <li class="sidebar-item"><a href="{{ userSettingsRoute() }}" class="sidebar-link"><i
                                    class="mdi mdi-account-edit"></i> <span class="hide-menu">
                                    الاعدادات الملف الشخصى
                                </span></a></li>
                        <li class="sidebar-item"><a href="{{ route('profile.password.change') }}"
