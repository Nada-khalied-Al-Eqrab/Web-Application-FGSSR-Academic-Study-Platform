...
Route::controller(CourseDiplomaController::class)->group(function () {
    ...
    Route::get('/course_diploma/destroy/{id}', 'destroy')->name('course_diploma.destroy');
    Route::get('/course_diploma/delete/all', 'deleteAll')->name('course_diploma.deleteAll');
});
...
Route::controller(DoctorCourseController::class)->group(function () {
    ...
    Route::get('/doctor_courses/delete-all', 'deleteAll')->name('doctor_courses.deleteAll');
});
